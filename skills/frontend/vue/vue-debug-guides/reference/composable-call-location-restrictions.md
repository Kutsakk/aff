...
// NOTE: Top-level await in <script setup> actually works (Vue compiler preserves context)
// But avoid calling composables in callbacks/setTimeout/nested async functions:
