...
| 3.5+ | Supported | Improved type resolution |

Vue 3.5+ includes improved type resolution for `defineProps`, meaning some patterns that previously caused "Unresolvable type reference" errors may now work. In particular, support for cross-file type references and more complex generics has been improved. However, very complex conditional types and deeply nested mapped types may still be unsupported. Always test your specific patterns when upgrading.
