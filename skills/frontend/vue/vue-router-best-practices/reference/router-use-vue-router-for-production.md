...
> **Caveat:** The Data Loading API shown below is **experimental** and still under active development. The final API may differ significantly from what is shown here. Check the [Vue Router RFC discussions](https://github.com/vuejs/rfcs/discussions) and official documentation for the latest status before using in production.

```javascript
// Data Loading API (experimental, API may change)
const routes = [
  {
    path: '/users/:id',
