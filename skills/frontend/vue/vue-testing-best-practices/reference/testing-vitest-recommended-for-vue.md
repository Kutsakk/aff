...
```javascript
// src/test/setup.js
// Use the Vitest-specific import for automatic setup:
import '@testing-library/jest-dom/vitest'

// Alternative (manual approach, also works):
...
export default defineConfig({
  ...
  test: {
    ...
    // NOTE: @vitest/coverage-v8 must be installed separately for coverage:
    ...
    reporters: ['verbose'],
    // Run tests in sequence in CI (Vitest 2+)
    pool: 'forks',
    poolOptions: {
      forks: {
