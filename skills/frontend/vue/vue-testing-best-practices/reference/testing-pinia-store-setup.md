...
When upgrading Pinia or `@pinia/testing`, ensure both packages are compatible. The `createTestingPinia` and `setActivePinia` APIs are stable across Pinia 2.x.

```bash
# Verify compatibility:
npm ls @pinia/testing pinia
```
